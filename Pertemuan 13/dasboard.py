...
class Dashboard:
    def __init__(self):
        ...
        self.mahasiswa_menu.add_command(label='Luas Persegi', command=lambda: self.new_window("Luas Persegi", FrmPersegi))
        self.mahasiswa_menu.add_command(label='Luas Segitiga', command=lambda: self.new_window("Luas Segitiga", FrmSegitiga))
        self.mahasiswa_menu.add_command(label='Luas Lingkaran', command=lambda: self.new_window("Luas Lingkaran", FrmLingkaran))
